...
insert into users(username,password,fullname,status)
values('tuankul','$2a$10$/RUbuT9KIqk6f8enaTQiLOXzhnUkiwEJRdtzdrMXXwU7dgnLKTCYG','thai thanh tuan',1);
...
values('BAIVIETTHETHAO1','test1','Bán kết world cup 1', 'Bán kết world cup 1', 'Bán kết world cup 1');
...
values('BAIVIETTHETHAO1','test1','Bán kết world cup 1', 'Bán kết world cup 1', 'Bán kết world cup 1', 1, 0);
